...
import { Box, Link, Stack, Button, Drawer, Tooltip, Typography, CardActionArea, Chip } from '@mui/material';
// hooks
    ...
    >
      ...
      >
        ...
        {isCollapse ? (
          ...
          <Link underline="none" component={RouterLink} to={PATH_DASHBOARD.app}>
            <AccountStyle>
              <MyAvatar />
              <Box sx={{ ml: 2 }}>
